...
def correct_open():
    with open(os.path.abspath(
            'tests/fixtures/test_yml/diff_open.md')) as correct_res:
...
def correct_raw():
    with open(os.path.abspath(
            'tests/fixtures/test_yml/diff_result_raw.md')) as correct_res:
        correct_res = correct_res.read().rstrip('\n')
    return correct_res
...
def correct_stylish():
    with open(
            'tests/fixtures/test_yml/diff_result_stylish.md') as correct_res:
        correct_res = correct_res.read().rstrip('\n')
    return correct_res
...
def correct_plain():
    with open(
            'tests/fixtures/test_yml/diff_result_plain.md') as correct_res:
        correct_res = correct_res.read().rstrip('\n')
    return correct_res
